#' Bank Queuing system
#'
#' @param Arrivals includes the number of customers, the time they arrive, and their service duration
#' @param ServiceTimes Includes the start time of service and the time where the service ends
#' @param NumServers the number of servers in the bank simulation
#'
